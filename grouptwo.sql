...
ALTER TABLE DEPARTMENT ADD CONSTRAINT fk_DEPARTMENT_SCHOOL FOREIGN KEY (DepID) REFERENCES SCHOOL (SchlID);
...
ALTER TABLE SCHOOLADR ADD CONSTRAINT fk_SCHOOLADR_SCHOOL FOREIGN KEY (BuildID) REFERENCES SCHOOL (SchlID);
